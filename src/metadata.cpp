...
CALF_PORT_PROPS(transientdesigner) = {
    ...
    { 100.f,  0.1f,  500.f,  0,  PF_FLOAT | PF_SCALE_LOG | PF_CTL_KNOB | PF_UNIT_MSEC, NULL, "attack_time", "Attack Time (ms)" },
    ...
    { 1000.f, 0.1f,  5000.f, 0,  PF_FLOAT | PF_SCALE_LOG | PF_CTL_KNOB | PF_UNIT_MSEC, NULL, "release_time", "Release Time (ms)" },
